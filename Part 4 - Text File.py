                ...
                if failcredit in [20 * i for i in range(7)]:
                    if passcredit + defercredit + failcredit == 120:
                        ...
                        if (continu == "q"):
                            ...
                            print("Progress", Progress, "|", "Trailer", Trailer, "|", "Retriever", Retriever, "|",
                                  "Excluded", Excluded)
                            ...
                            a_list = (passcredit, defercredit, failcredit)
                            textfile = open("textfile.txt", "w")
                            textfile.write(str("Progress : "))
                            textfile.write(str(Pro))
                            textfile.write("\n")
                            textfile.write(str("Progress (module trailer) : "))
                            textfile.write(str(Tra))
                            textfile.write("\n")
                            textfile.write(str("Module retriever : "))
                            textfile.write(str(Ret))
                            textfile.write("\n")
                            textfile.write(str("Exclude : "))
                            textfile.write(str(Exc))
                            textfile.close()
